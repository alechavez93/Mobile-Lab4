/*--------------------------------------------------------------------------------------
|	RequestAPI Class: Created by Alejandro Chavez on 3/19/2017.
|---------------------------------------------------------------------------------------
|   Description: Provides a nice and easy to use set of methods to deal with any kind
|   of HTTP request. Centralizes access to the server.
---------------------------------------------------------------------------------------*/

package com.example.ale.beacontracker.ServerAdapter;
